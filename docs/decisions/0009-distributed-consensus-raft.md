# Decision 0009: Distributed Consensus via OpenRaft and Replicated State Machine
...
Single-node WAL persistence (Decision 0007) guarantees crash recovery on a single machine, but hardware
